(function(){
  const texts={
    ja:{title:"PSO2 特殊能力追加シミュレーター",lang:"言語",save:"保存",load:"読込",copy:"URLコピー",reset:"クリア",
        ...
        campaign:"報酬期間",same:"本体・使用素材はすべて同名",tip:"本体と、現在使用している全素材が完全に同じ装備名の場合のみ有効",addItem:"追加アイテムを使用",addItemTip:"特殊能力追加アイテムを1個使用し、追加アイテム能力を候補に表示します",junkFill:"全本体・素材をゴミで",junkFillSuffix:"まで埋める",junkFillBtn:"実行",junkClear:"全ゴミ削除",candidate:"追加候補 / 成功率"},
    "zh-CN":{title:"PSO2 特殊能力追加模拟器",lang:"语言",save:"保存",load:"读取",copy:"复制URL",reset:"清空",
        ...
        campaign:"奖励期间",same:"本体·使用素材全部同名",tip:"仅当本体与当前使用的全部素材装备名完全相同时生效",addItem:"使用追加道具",addItemTip:"使用1个特殊能力追加道具，并在追加候选中显示对应的追加道具能力",junkFill:"所有本体和素材用垃圾能力填充至",junkFillSuffix:"孔",junkFillBtn:"执行",junkClear:"删除全部垃圾能力",candidate:"追加候选 / 成功率"}
  };
