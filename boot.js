(function(){
  const texts={
    ja:{title:"PSO2 特殊能力追加シミュレーター",lang:"言語",save:"保存",load:"読込",copy:"URLコピー",reset:"クリア",
        ...
        campaign:"報酬期間",same:"本体・使用素材はすべて同名",tip:"本体と、現在使用している全素材が完全に同じ装備名の場合のみ有効",candidate:"追加候補 / 成功率"},
    "zh-CN":{title:"PSO2 特殊能力追加模拟器",lang:"语言",save:"保存",load:"读取",copy:"复制URL",reset:"清空",
        ...
        campaign:"奖励期间",same:"本体·使用素材全部同名",tip:"仅当本体与当前使用的全部素材装备名完全相同时生效",candidate:"追加候选 / 成功率"}
  };
  ...
  $("#sameNameText").textContent=t.same; $("#sameNameLabel").title=t.tip; $("#candidateTitle").textContent=t.candidate;
