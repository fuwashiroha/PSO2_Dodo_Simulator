(function(){
  const texts={
    ja:{title:"PSO2 特殊能力追加シミュレーター V27.8",lang:"言語",save:"保存",load:"読込",copy:"URLコピー",reset:"クリア",
    ...
    "zh-CN":{title:"PSO2 特殊能力追加模拟器 V27.8",lang:"语言",save:"保存",load:"读取",copy:"复制URL",reset:"清空",
